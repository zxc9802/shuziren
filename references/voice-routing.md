...
Ask exactly: **“这次配音使用 MiniMax，还是 HeyGen？”** Do this immediately after authorization and before the company-material question or any script work. Auto mode skips this question and records `minimax` unless the same-turn auto request explicitly names HeyGen.
